...
class CifarResNeXt(nn.Module):
  ...
  """
  def __init__(self, block, depth, cardinality, base_width, num_classes, Ddim):
...
#    self.classifier = nn.Linear(256*block.expansion, num_classes)
    self.classifier = ops.LinearCapsPro(256*block.expansion, num_classes, Ddim)
...
def resnext29_16_64(num_classes=10, Ddim=4):
  """Constructs a ResNeXt-29, 16*64d model for CIFAR-10 (by default)
  
  Args:
    num_classes (uint): number of classes
  """
  model = CifarResNeXt(ResNeXtBottleneck, 29, 16, 64, num_classes, Ddim)
  return model

def resnext29_8_64(num_classes=10, Ddim=4):
  """Constructs a ResNeXt-29, 8*64d model for CIFAR-10 (by default)
  
  Args:
    num_classes (uint): number of classes
  """
  model = CifarResNeXt(ResNeXtBottleneck, 29, 8, 64, num_classes, Ddim)
  return model
